...
public class Claim implements Iterable<Coordinate> {
    ...
    public Claim expand(CuboidDirection dir, int amount) {
        return switch (dir) {
            case North -> (new Claim(world, this.x1 - amount, this.y1, this.z1, this.x2, this.y2, this.z2));
            case South -> (new Claim(world, this.x1, this.y1, this.z1, this.x2 + amount, this.y2, this.z2));
            case East -> (new Claim(world, this.x1, this.y1, this.z1 - amount, this.x2, this.y2, this.z2));
            case West -> (new Claim(world, this.x1, this.y1, this.z1, this.x2, this.y2, this.z2 + amount));
            case Down -> (new Claim(world, this.x1, this.y1 - amount, this.z1, this.x2, this.y2, this.z2));
            case Up -> (new Claim(world, this.x1, this.y1, this.z1, this.x2, this.y2 + amount, this.z2));
